...
$('body').css('background-image','url("asset/img/drizzle.jpg")'); 
    ...
    break;
         case 'Thunderstorm':$('#icon').append('<i class="wi wi-storm-showers"></i>');
           $('body').css('background-image','url("asset/img/thunder.jpg")')
    break;  
               case 'Snow':$('#icon').append('<i class="wi wi-snow"></i>');
           $('body').css('background-image','url("asset/img/winter.jpg")')
    break;  
                     case 'Mist':$('#icon').append('<i class="wi wi-fog"></i>');
           $('body').css('background-image','url("asset/img/mist.jpg")')
    break;  
    ...
    break;  
           ...
           $('body').css('background-image','url("asset/img/haze.jpg")')
    break;  
  }
}
